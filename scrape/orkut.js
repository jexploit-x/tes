...
let { directLink } = await service.uploadFromBinary(buffer, 'jexploit.png');
            resolve(directLink);
        } catch (error) {
...
async function checkQRISStatus() {
    try {
        const apiUrl = `https://gateway.okeconnect.com/api/mutasi/qris/${global.merchan}/${global.apikey}`;
